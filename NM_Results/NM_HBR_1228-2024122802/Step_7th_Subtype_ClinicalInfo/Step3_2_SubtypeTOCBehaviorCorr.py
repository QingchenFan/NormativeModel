...
for b in csvdata:
  ...
  print(name)
  for i in range(1, 3):
      file_1 = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults/' \
      ...
      box.append(df_new)
      df_new.to_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults/TOC/subtype'+str(i)+'_TOC_'+name+'.csv', index=False)
print("Done")

# # 第二步计算相关
file_1 = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults/TOC/*.csv'
