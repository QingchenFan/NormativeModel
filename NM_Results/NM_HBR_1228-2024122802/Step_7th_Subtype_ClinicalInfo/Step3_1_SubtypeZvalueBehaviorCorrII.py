...
cldata = glob.glob('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults/subtypeClinical/*subtype1*.csv')
for j in cldata:
    ...
    result_df.to_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults/subtypeClinical/CorrII/'
                     'Step5_3_sbutype1''_Zvalue_Corr_'+sbty, index=False)
