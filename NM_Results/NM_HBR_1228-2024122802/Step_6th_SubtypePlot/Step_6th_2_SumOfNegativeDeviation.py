...
asd1 = pd.read_csv(
    '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801/Step_5th_Subtype/step7_Subtype1_Negative_LessThan_-196sum.csv', index_col=0)
data1 = list(asd1['sum_196'])

asd = pd.read_csv(
    '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801/Step_5th_Subtype/step7_Subtype2_Negative_LessThan_-196sum.csv', index_col=0)
