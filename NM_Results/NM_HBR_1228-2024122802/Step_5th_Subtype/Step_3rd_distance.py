...
d1 = pd.read_csv('/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801/Step_5th_Subtype/step2_group_subtype1.csv', index_col=0)
d1=d1.iloc[:, 1:].values
print(d1)

d2 = pd.read_csv('/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801/Step_5th_Subtype/step2_group_subtype2.csv', index_col=0)
d2=d2.iloc[:, 1:].values
print(d2.shape)
