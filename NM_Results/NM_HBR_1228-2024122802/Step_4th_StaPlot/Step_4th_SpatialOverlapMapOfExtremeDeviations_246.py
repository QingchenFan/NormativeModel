...
#csv_path = '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801/Step_3th_OutliersCount/Step3_Z_AllMDD_NegativeBrainRegionNum.csv'
csv_path = '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801/Step_3th_OutliersCount/Step3_Z_AllMDD_PositiveBrainRegionNum.csv'

weight_data = pd.read_csv(csv_path)
print(weight_data.shape)

sumRegion = weight_data.iloc[267:268, 2:].values
