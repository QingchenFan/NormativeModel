...
subtype1_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1030/StaResults/step5_subtype1_GreaterOrLess_RegionNum_1.96num.csv'
subtype2_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1030/StaResults/step5_subtype2_GreaterOrLess_RegionNum_1.96num.csv'

showDiff(subtype1_path,subtype2_path, datatype='TOC',Mark='outliers_counts', savepath='./')
