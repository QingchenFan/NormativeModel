...
HCdata = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1129/StaResults/GrayVol246_Z_AllHCestimate.csv', index_col=0)
MDDdata = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1129/StaResults/GrayVol246_Z_AllMDD.csv', index_col=0)
