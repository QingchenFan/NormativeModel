...
data = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1129/StaResults/Longitudinal'
                   '/GrayVol246_Z_wkkwww.csv')
...
data.to_csv('./wkkww_GreaterOrLess_1.96num.csv')
