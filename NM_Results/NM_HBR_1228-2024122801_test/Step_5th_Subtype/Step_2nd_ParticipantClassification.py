...
alldata = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/GrayVol246_Z_AllMDD.csv')
...
#
x1 = alldata[label_pred == 0]
x2 = alldata[label_pred == 1]
