...
# 假设有两组数据
after = pd.read_csv(
    '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1129/StaResults/Longitudinal/subtype1_Negative_LessThan_-196sum_52w.csv')
data1 = list(after['sum_196'])
print(data1)
before = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1129/StaResults/Longitudinal/subtype1_Negative_LessThan_-196sum_0w.csv')
