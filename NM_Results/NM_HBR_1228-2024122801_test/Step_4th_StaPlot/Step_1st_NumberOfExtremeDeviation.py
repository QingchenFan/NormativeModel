...
'''
# 假设有两组数据
hc = pd.read_csv('/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801_test/Step_3th_OutliersCount/Step1_Z_AllHCestimate_GreaterOrLess_1.96num.csv', index_col=0)
data1 = list(hc['outliers_counts'])

mdd = pd.read_csv(
    '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801_test/Step_3th_OutliersCount/Step1_Z_AllMDD_GreaterOrLess_1.96num.csv', index_col=0)
