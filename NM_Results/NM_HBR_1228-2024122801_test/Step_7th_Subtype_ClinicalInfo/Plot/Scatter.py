...
# 用于画 PLSC 的结果散点图
# 读取CSV文件
data_subtype1 = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/PLSC/subtype1_Brain_Lx.csv')
data_subtype2 = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/PLSC/subtype1_HAMD_Ly.csv')
