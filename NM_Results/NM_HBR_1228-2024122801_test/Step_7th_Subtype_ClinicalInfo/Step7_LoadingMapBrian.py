...
# 加载 CSV 文件
csv_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/PLSC/subtype1_BrainHAMD_loading.csv'
weight_data = pd.read_csv(csv_path, header=None)

# 读取 结果指标 列，可以是SMSE\MSLL
smse_values = weight_data.iloc[:, 1:2] .values
...
scalar_img.to_filename('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/PLSC/subtype1_BrainHAMD_loading.dscalar.nii')
