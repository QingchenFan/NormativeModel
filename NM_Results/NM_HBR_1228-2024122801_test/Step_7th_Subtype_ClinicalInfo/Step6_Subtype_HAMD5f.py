...
subtype1_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/subtype1_Zvalue_HAMD_5ft.csv'
subtype2_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/subtype2_Zvalue_HAMD_5ft.csv'
subtype1_data = pd.read_csv(subtype1_path)
subtype2_data = pd.read_csv(subtype2_path)
a = ['f1', 'f2', 'f3', 'f4', 'f5']
pbox = []
