...
import glob
# 量表 与 每个脑区z 值算个相关性，有待商榷计算这个结果
file_1 = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/subtypeClinical/*.csv'
...
for i in csv:
    ...
    result_df.to_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/subtypeClinical/Corr/'
