...
# 找到脑区对应的索引
Regionscsv_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults/' \
                  'hbr_estimate_GrayVol246_ResSum.csv'
Regions_data = pd.read_csv(Regionscsv_path)
region = Regions_data['Regions'][0:210]

# 加载 CSV 文件
csv_path = '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801_test/Step_5th_Subtype/' \
...
scalar_img.to_filename('./step4_subtype2_Regionmean.dscalar.nii')
