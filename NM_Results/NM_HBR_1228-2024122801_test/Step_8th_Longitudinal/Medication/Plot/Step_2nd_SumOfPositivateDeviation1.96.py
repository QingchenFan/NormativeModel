...
# 假设有两组数据
hc = pd.read_csv(
    '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/Longitudinal/Medication/w8/SSRI/subtype_2_Z_AllMDD_GreaterThan_196sum.csv')
data1 = list(hc['sum_196'])
print(data1)
mdd = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/Longitudinal/Medication/w8/SSRI/subtype2_SSRI_m8w_Z8w.csv_Positive_GreaterThan_196sum.csv')
...
plt.savefig('./subtype1_SumOfPositivateDeviation1.96.png', dpi=300)
# 显示图表
plt.show()
