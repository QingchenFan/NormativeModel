...
data = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/Longitudinal/Medication/w8/SSRI/Medication_m8w_Z8w.csv')
...
# 将更新后的数据框写入新的CSV文件
data.to_csv('./SSRI_m8w_Z8w.csv_Positive_GreaterThan_196sum.csv', index=False)