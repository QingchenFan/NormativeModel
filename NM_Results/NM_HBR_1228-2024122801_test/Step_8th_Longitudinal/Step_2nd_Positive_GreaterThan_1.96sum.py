...
data = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1228/StaResults_test/Longitudinal/Medication/'
                   'First_Medication_8w_noresp.csv')
...
# 将更新后的数据框写入新的CSV文件
data.to_csv('./First_Medication_8w_noresp_Positive_GreaterThan_196sum.csv', index=False)