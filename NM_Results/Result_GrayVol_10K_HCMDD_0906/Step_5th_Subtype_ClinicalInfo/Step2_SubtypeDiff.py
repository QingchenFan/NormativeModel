...
subtype1_path = './subtype1_BrainPro_Clinicalinfo.csv'
subtype2_path = './subtype2_BrainPro_Clinicalinfo.csv'

showDiff(subtype1_path,subtype2_path, datatype='BrainPro',Mark='PSS', savepath='./')
