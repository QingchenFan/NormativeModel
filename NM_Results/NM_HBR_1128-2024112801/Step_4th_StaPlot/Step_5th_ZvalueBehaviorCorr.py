...
file_2 = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1128/StaResults/ClinicalInfo/' \
         'allDataMDD_HAMD.csv'
...
df_new.to_csv('./Step5_allDataMDD_Zvalue_HAMD.csv',index=False)



# Read the CSV files into DataFrames
df1 = pd.read_csv('./Step5_allDataMDD_Zvalue_HAMD.csv')
