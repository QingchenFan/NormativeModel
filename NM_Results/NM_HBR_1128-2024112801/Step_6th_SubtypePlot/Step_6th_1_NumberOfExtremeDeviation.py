...
# 假设有两组数据
hc = pd.read_csv(
    '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1128/StaResults/Step1_Z_AllHCestimate_GreaterOrLess_1.96num.csv', index_col=0)
data = list(hc['outliers_counts'])

asd1 = pd.read_csv(
    '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1128-2024112801/Step_5th_Subtype/step5_subtype1_GreaterOrLess_RegionNum_1.96num.csv', index_col=0)
data1 = list(asd1['outliers_counts'])

asd = pd.read_csv(
    '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1128-2024112801/Step_5th_Subtype/step5_subtype2_GreaterOrLess_RegionNum_1.96num.csv', index_col=0)
