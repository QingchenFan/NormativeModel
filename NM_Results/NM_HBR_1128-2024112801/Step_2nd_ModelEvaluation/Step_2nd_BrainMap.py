...
# 加载 CSV 文件
csv_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1128/StaResults/hbr_estimate_GrayVol246_ResSum.csv'
...
scalar_img.to_filename('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1128/StaResults/SMSE.dscalar.nii')
