...
for b in csvdata:
  ...
  print(name)
  for i in range(1, 3):
      file_1 = '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1128-2024112801/Step_5th_Subtype/' \
      ...
      box.append(df_new)
      df_new.to_csv('./Step5_1_subtype'+str(i)+'_Zvalue'+name+'.csv', index=False)
