...
import glob
# copy 一个GrayVol246_Z_AllMDD.csv 文件进行 此文件subID应修改过
file_1 = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1030/StaResults/subtypeBehavior/*.csv'
...
for i in csv:
    ...
    result_df.to_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1030/StaResults/subtypeBehavior/'
                     'Step5_3_'+sbty+'_Zvalue'+cl[0]+'Corr.csv', index=False)