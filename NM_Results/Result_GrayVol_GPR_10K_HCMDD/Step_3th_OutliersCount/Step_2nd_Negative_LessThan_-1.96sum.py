...
data = pd.read_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol_10K_HCMDD_0826/StaResults/'
                  'GrayVol_Z_AllHCestimate.csv')
sunID = data['subID']
data = data.iloc[:,1:]
# 打印原始数据
print(data)
...
# 将更新后的数据框写入新的CSV文件
data.to_csv('./GPR_0826_Step2_Z_AllHCestimate400_LessThan_-196sum.csv', index=False)