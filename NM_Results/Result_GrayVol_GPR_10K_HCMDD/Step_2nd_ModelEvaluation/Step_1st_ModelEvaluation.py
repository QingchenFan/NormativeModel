...
def plotModel(ipath,opath,mark):
    ...
    plt.xlabel('MLSS',size=16)
    plt.ylabel('Density',size=16)
    plt.savefig(opath ,dpi=300)
    # 显示图形
    plt.show()

ipath = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_GPH_5K_HCMDD_1022/StaResults/GPR_GrayVol246_HC_ResSum.csv'
opath = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_GPH_5K_HCMDD_1022/StaResults/ModelEvaluation_MSLL.png'
mark = 'MSLL'
