...
print(data1)
mdd = pd.read_csv('/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1228-2024122801/Step_3th_OutliersCount/Step2_Z_AllMDD_GreaterThan_196sum.csv', index_col=0)
