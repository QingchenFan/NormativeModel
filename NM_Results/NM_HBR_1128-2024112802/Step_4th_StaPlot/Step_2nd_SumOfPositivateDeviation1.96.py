...
# 假设有两组数据
hc = pd.read_csv(
    '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1128-2024112802/Step_3th_OutliersCount/Step2_Z_AllHCestimate_GreaterThan_196sum.csv', index_col=0)
data1 = list(hc['sum_196'])
print(data1)
mdd = pd.read_csv('/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1128-2024112802/Step_3th_OutliersCount/Step2_Z_AllMDD_GreaterThan_196sum.csv', index_col=0)
