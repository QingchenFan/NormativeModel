...
# 加载 CSV 文件
csv_path = '/NM_Results/Result_GrayVol_GPR_10K_HCMDD/Step_5th_Subtype/step4_group_subtype2_Regionmean.csv'
...
# 找到脑区对应的索引
Regionscsv_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol_GPR_10K_HCMDD/StaResults/GrayVol_ResSum.csv'
...
scalar_img.to_filename('./subtype2_xxxMeanDeviation.dscalar.nii')
