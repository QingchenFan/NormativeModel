...
# 加载 CSV 文件
csv_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol_GPR_10K_HCMDD/StaResults/GrayVol_ResSum.csv'
...
scalar_img.to_filename('/Volumes/QCI/NormativeModel/Results/Result_GrayVol_GPR_10K_HCMDD/StaResults/MAE_estimate.dscalar.nii')
