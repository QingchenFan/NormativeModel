...
csvdata = glob.glob("/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1128/StaResults/ClinicalInfo/*.csv")
...
for b in csvdata:
  ...
  for i in range(1, 3):
      ...
      box.append(df_new)
      df_new.to_csv('/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1128/StaResults/subtypeClinical/DL_Step5_1_subtype'+str(i)+'_Zvalue_'+name+'.csv', index=False)
