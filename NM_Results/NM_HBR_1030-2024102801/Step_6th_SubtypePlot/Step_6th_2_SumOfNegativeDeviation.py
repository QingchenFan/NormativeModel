...
# 假设有两组数据
hc = pd.read_csv(
    '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1030-2024102801/Step_3th_OutliersCount/Step2_Z_AllHCestimate_LessThan_-196sum.csv', index_col=0)
data = list(hc['sum_196'])

asd1 = pd.read_csv(
    '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1030-2024102801/Step_5th_Subtype/step7_Subtype1_Negative_LessThan_-196sum.csv', index_col=0)
data1 = list(asd1['sum_196'])

asd = pd.read_csv(
    '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1030-2024102801/Step_5th_Subtype/step7_Subtype2_Negative_LessThan_-196sum.csv', index_col=0)
