...
label[label > 210] -= 210
pvalue = pd.read_csv('/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1129-2024112901/Step_3th_OutliersCount/Step5_MDDHCCond.csv')
...
scalar_img.to_filename('./Ttestp_MDDHC.dscalar.nii')