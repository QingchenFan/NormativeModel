...
# 找到脑区对应的索引
Regionscsv_path = '/Volumes/QCI/NormativeModel/Results/Result_GrayVol246_HBR_HCMDD_1129/StaResults/hbr_estimate_GrayVol246_ResSum.csv'
Regions_data = pd.read_csv(Regionscsv_path)
region = Regions_data['Regions'][0:210]

# 加载 CSV 文件 TODO: 负向 正向
csv_path = '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1129-2024112901/Step_3th_OutliersCount/Step3_Z_AllMDD_NegativeBrainRegionNum.csv'
#csv_path = '/Users/qingchen/Documents/code/NormativeModel/NM_Results/NM_HBR_1129-2024112901/Step_3th_OutliersCount/Step3_Z_AllMDD_PositiveBrainRegionNum.csv'
