...
DLHCGrayVol = pd.read_csv('/Volumes/QCI/NormativeModel/FeatureData/StructureFeature/StructureFeature_246/DuiLie/DuiLieHCGrayVol_246.csv')
DLHCGrayVol_df = pd.merge(DLHClabel, DLHCGrayVol, on='subID', how='inner')
DLHCGrayVol_df.to_csv('./DuiLieHCGrayVol246_sum.csv', index=False)
...
DuiLieMDDGrayVol = pd.read_csv('/Volumes/QCI/NormativeModel/FeatureData/StructureFeature/StructureFeature_246/DuiLie/DuiLieMDDGrayVol_246.csv')
DuiLieMDDGrayVol_df = pd.merge(DuiLieMDDlabel, DuiLieMDDGrayVol, on='subID', how='inner')
DuiLieMDDGrayVol_df.to_csv('./DuiLieMDDGrayVol246_sum.csv', index=False)
#
