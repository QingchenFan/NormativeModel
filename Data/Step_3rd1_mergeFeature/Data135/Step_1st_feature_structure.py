...
Data135HCGrayVol = pd.read_csv('/Volumes/QCI/NormativeModel/FeatureData/StructureFeature/StructureFeature_246/Data135/Data135HCGrayVol_246.csv')
Data135HCGrayVol_df = pd.merge(Data135HClabel, Data135HCGrayVol, on='subID', how='inner')
Data135HCGrayVol_df.to_csv('./Data135HCGrayVol246_sum.csv', index=False)
#
#
...
Data135MDDGrayVol = pd.read_csv('/Volumes/QCI/NormativeModel/FeatureData/StructureFeature/StructureFeature_246/Data135/Data135MDDGrayVol_246.csv')
Data135MDDGrayVol_df = pd.merge(Data135MDDlabel, Data135MDDGrayVol, on='subID', how='inner')
Data135MDDGrayVol_df.to_csv('./Data135MDDGrayVol246_sum.csv', index=False)
