...
Data135MDDGrayVol = pd.read_csv('/Volumes/QCI/NormativeModel/FeatureData/StructureFeature/Data135/Data135MDDGrayVol.csv')
Data135MDDGrayVol_df = pd.merge(Data135MDDlabel, Data135MDDGrayVol, on='ID', how='inner')
Data135MDDGrayVol_df.to_csv('./Data135MDDGrayVol_sum.csv', index=False)
