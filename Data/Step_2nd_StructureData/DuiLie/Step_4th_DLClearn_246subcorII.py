...
path = '/Volumes/QCI/NormativeModel/DuiLie/MDD/DuiLie_Strufeature_Brainnetom/*/*_GrayVol.csv'
data = glob.glob(path)
for i in data:
    ...
    subcpath ="/Volumes/QCI/NormativeModel/DuiLie/MDD/DuiLie_Strufeature_Brainnetom/"+subId+"/BN_Atlas_subcotex.txt"
    ...
    # 保存新的CSV文件
    result_df.to_csv('/Volumes/QCI/NormativeModel/DuiLie/MDD/DuiLie_Strufeature_Brainnetom/'+subId+'/'+subId+'_GrayVolSubcortical.csv', index=False)
