...
datapath = glob.glob('/Volumes/QCI/NormativeModel/Data135/MDD/Strufeature_BrainnetomV2/*/*_GrayVol.csv')
...
for file in datapath:
    ...
    subID = file.split('/')[-2]
    print(subID)
    folder_path = '/Volumes/QCI/NormativeModel/Data135/MDD/Strufeature_BrainnetomV2/' + subID
...
# 保存拼接后的数据到新的 CSV 文件
concatenated_data.to_csv('./Data135_MDDGrayVol_BN224_V2.csv', index=False)
