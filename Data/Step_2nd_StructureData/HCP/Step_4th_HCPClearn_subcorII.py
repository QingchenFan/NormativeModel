...
path = '/Volumes/QCI/HCPData/HCP_Struc_246/*/*_GrayVol.csv'
data = glob.glob(path)
for i in data:
    ...
    subcpath ="/Volumes/QCI/HCPData/HCP_Struc_246/"+subId+"/BN_Atlas_subcotex.txt"
    if not os.path.exists(subcpath):
        print("File does not exist:", subcpath)
        continue
    ...
    # 保存新的CSV文件
    result_df.to_csv('/Volumes/QCI/HCPData/HCP_Struc_246/'+subId+'/'+subId+'_GrayVolSubcortical.csv', index=False)
