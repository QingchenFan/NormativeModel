...
datapath = glob.glob('/Volumes/QCI/NormativeModel/BrainProject/NP_stru_brainnetom_V14/*/*_GrayVol.csv')
...
for file in datapath:
    ...
    #  方便 246 模版
    subID = file.split('/')[-2]
    folder_path = '/Volumes/QCI/NormativeModel/BrainProject/NP_stru_brainnetom_V14/' + subID
...
# 保存拼接后的数据到新的 CSV 文件
concatenated_data.to_csv('./NP_GrayVol_BN14subcor_V14.csv', index=False)
