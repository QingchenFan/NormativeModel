...
for i in datapath:
    ...
    if 'fsaverage' in i:
        continue
    newpath = '/Volumes/QCI/NormativeModel/BrainProject/NP_stru_brainnetom_V14/' + subID
    if not os.path.exists(newpath):
        os.mkdir(newpath)

    inl = '''
            export FREESURFER_HOME=/Applications/freesurfer/7.4.1; \
            export SUBJECTS_DIR=''/Volumes/QCII/BrainProject/fmriprep_out_PDV24/sourcedata/freesurfer/'';\
